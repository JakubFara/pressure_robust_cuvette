...
theta = x * 2 * np.pi / length_x
r0 = 1.0
r = r0 + y
expr_x_outer = r * fd.cos(theta) - x
expr_y_outer = r * fd.sin(theta) - y
expr_x_inner = r * fd.cos(theta) - x
expr_y_inner = r * fd.sin(theta) - y
...
bc_x_inner_bndry = fd.DirichletBC(V.sub(0), expr_x_inner_bndry, (21, 22, 23, 24))
bc_y_inner_bndry = fd.DirichletBC(V.sub(1), expr_y_inner_bndry, (21, 22, 23, 24))
