...
bc_x_outer = fd.DirichletBC(W.sub(0), expr_x_outer, (11, 12, 13, 14))
bc_y_outer = fd.DirichletBC(W.sub(1), expr_y_outer, (11, 12, 13, 14))
bc_x_inner = fd.DirichletBC(W.sub(0), expr_x_inner, (21, 22, 23, 24))
bc_y_inner = fd.DirichletBC(W.sub(1), expr_y_inner, (21, 22, 23, 24))
